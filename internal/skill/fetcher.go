...
// fetchRemoteAll fetches from GitHub, npm, awesome-lists, skill registries,
// and code search concurrently. A single source failure does not block the others.
